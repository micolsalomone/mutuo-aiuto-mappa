...
Se vuoi, preparo un modello di issue più dettagliato o uno script per validare il GeoJSON prima della PR.
```// filepath: c:\Users\blurr\Documents\GitHub\mutuo-aiuto-mappa\README.md
# Mutuo Aiuto — Mappa dei Centri
